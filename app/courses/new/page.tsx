      ...
      <div>
        {copy ? (
          <>
            ...
            <FieldEditor label="og:title" value={copy.ogTitleBn} onChange={(v) => setCopyField("ogTitleBn", v)} />
            <FieldEditor label="og:description" value={copy.ogDescriptionBn} onChange={(v) => setCopyField("ogDescriptionBn", v)} multiline />
