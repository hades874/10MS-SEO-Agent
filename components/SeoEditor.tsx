...
export function SeoEditor({
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      ...
      <FieldEditor label="og:title" value={copy.ogTitleBn} onChange={(v) => setField("ogTitleBn", v)} />
      <FieldEditor label="og:description" value={copy.ogDescriptionBn} onChange={(v) => setField("ogDescriptionBn", v)} multiline />
